...
public class ColoredAllayModel extends SinglePartEntityModel<ColoredAllayEntity> implements ModelWithArms {
    ...
    public void setAngles(ColoredAllayEntity allayEntity, float f, float g, float h, float i, float j) {
        ...
        if (allayEntity.isDancing()) {
            ...
            u = MathHelper.cos(r) * 14.0F * 0.017453292F;
            float v = MathHelper.cos(r) * 30.0F * 0.017453292F;
            this.root.yaw = allayEntity.method_44360() ? 12.566371F * t : this.root.yaw;
        ...
        t = p * (1.0F - q);
        u = 0.43633232F - MathHelper.cos(n + 4.712389F) * 3.1415927F * 0.075F * t;
        this.leftArm.roll = -u;
    ...
    public void setArmAngle(Arm arm, MatrixStack matrices) {
        ...
        matrices.multiply(RotationAxis.POSITIVE_X.rotation(this.rightArm.pitch + 0.43633232F));
