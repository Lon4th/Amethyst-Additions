...
public abstract class RedWaterFluid extends FlowableFluid {
    ...
    public Fluid getFlowing() {
        return ModFluids.RED_WATER_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.RED_WATER_STILL;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return ModBlocks.RED_WATER_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }

    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.RED_WATER_STILL || fluid == ModFluids.RED_WATER_FLOWING;
    }
