...
public class ModParticles {
    ...
    public static void registerParticles() {
        ...
        Registry.register(Registry.PARTICLE_TYPE, new Identifier(AmethystAdditions.MOD_ID, "red_dust_particle"), RED_DUST);
        Registry.register(Registry.PARTICLE_TYPE, new Identifier(AmethystAdditions.MOD_ID, "yellow_dust_particle"), YELLOW_DUST);
        Registry.register(Registry.PARTICLE_TYPE, new Identifier(AmethystAdditions.MOD_ID, "orange_dust_particle"), ORANGE_DUST);
        Registry.register(Registry.PARTICLE_TYPE, new Identifier(AmethystAdditions.MOD_ID, "brown_dust_particle"), BROWN_DUST);
        Registry.register(Registry.PARTICLE_TYPE, new Identifier(AmethystAdditions.MOD_ID, "lime_dust_particle"), LIME_DUST);
        Registry.register(Registry.PARTICLE_TYPE, new Identifier(AmethystAdditions.MOD_ID, "green_dust_particle"), GREEN_DUST);
        Registry.register(Registry.PARTICLE_TYPE, new Identifier(AmethystAdditions.MOD_ID, "light_blue_dust_particle"), LIGHT_BLUE_DUST);
        Registry.register(Registry.PARTICLE_TYPE, new Identifier(AmethystAdditions.MOD_ID, "cyan_dust_particle"), CYAN_DUST);
        Registry.register(Registry.PARTICLE_TYPE, new Identifier(AmethystAdditions.MOD_ID, "blue_dust_particle"), BLUE_DUST);
        Registry.register(Registry.PARTICLE_TYPE, new Identifier(AmethystAdditions.MOD_ID, "purple_dust_particle"), PURPLE_DUST);
        Registry.register(Registry.PARTICLE_TYPE, new Identifier(AmethystAdditions.MOD_ID, "magenta_dust_particle"), MAGENTA_DUST);
        Registry.register(Registry.PARTICLE_TYPE, new Identifier(AmethystAdditions.MOD_ID, "pink_dust_particle"), PINK_DUST);
        Registry.register(Registry.PARTICLE_TYPE, new Identifier(AmethystAdditions.MOD_ID, "white_dust_particle"), WHITE_DUST);
        Registry.register(Registry.PARTICLE_TYPE, new Identifier(AmethystAdditions.MOD_ID, "light_gray_dust_particle"), LIGHT_GRAY_DUST);
        Registry.register(Registry.PARTICLE_TYPE, new Identifier(AmethystAdditions.MOD_ID, "gray_dust_particle"), GRAY_DUST);
        Registry.register(Registry.PARTICLE_TYPE, new Identifier(AmethystAdditions.MOD_ID, "black_dust_particle"), BLACK_DUST);
    }
}
